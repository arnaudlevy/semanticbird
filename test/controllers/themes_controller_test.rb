...
class ThemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theme" do
    assert_difference('Theme.count') do
      post themes_url, params: { theme: { color: @theme.color, name: @theme.name, parent_id: @theme.parent_id } }
    end
  ...
  test "should update theme" do
    patch theme_url(@theme), params: { theme: { color: @theme.color, name: @theme.name, parent_id: @theme.parent_id } }
